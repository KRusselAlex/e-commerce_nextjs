  ...
  navMain: [
    {
      ...
      items: [{ title: "Analytics", url: "/oniichan" }],
    },
    {
      ...
      items: [
        { title: "Products", url: "/oniichan/shop/product" },
        { title: "Categories", url: "/oniichan/shop/categories" },
        { title: "Add Products", url: "/oniichan/shop/add-product" },
      ],
    },
    {
      title: "Orders",
      url: "#",
      icon: <ShoppingCart className="h-5 w-5" />,
      items: [{ title: "Order List", url: "/oniichan/order" }],
    },
    // {
    ...
    // },
    {
      ...
      items: [
        { title: "Profile", url: "/oniichan/profil" },
        { title: "Logout", url: "#" },
      ],
    },
  ],
